...
ggsave("heatmap.overlap.orthogroups.png", width = 12, height = 10, units = "in", dpi = 300)
ggsave("heatmap.overlap.orthogroups.tiff", width = 12, height = 10, units = "in", dpi = 300)
